...
│   ├── calendar.py      # Kalender-Ansicht + My Calendar API (Phase 2)
│   ├── scoreboard.py    # Legacy Gamification
│   ├── user_profile.py  # Legacy Profile
│   ├── gamification/    # Gamification-Features
│   │   └── legacy_routes.py  # MODIFIED: Analytics-Import entfernt (v3.3.11)
│   ├── slots.py         # Neue Slots (Fallback)
│   └── t2.py            # T2-Closer (1947 Zeilen, 11 neue APIs - v3.3.11)
